...
if __name__ == '__main__':
    ...
    arser.add_argument('--input_dim', type=int, default=2, metavar='IN',
                        help='number of input features to model (default: 2)')
    arser.add_argument('--hidden_dim', type=int, default=10, metavar='H',
                        help='hidden dim of model (default: 10)')
    arser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
    ...
    model = SimpleNet(args.input_dim, args.hidden_dim, args.output_dim).to_device()
